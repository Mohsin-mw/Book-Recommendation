...
const Page = () => {
  ...
  async function handleLogin(values: z.infer<typeof registerSchema>) {
          ...
          <div className="mx-auto w-full max-w-sm lg:w-96">
            <div className="flex-column-center">
              ...
              <p className="mt-2 text-sm text-gray-600">
                ...
                <Link className="font-bold text-primary-500" href={"/signIn"}>
                  Sign In
                </Link>
              </p>
            </div>
                ...
                <Form {...form}>
                  ...
                  >
                    ...
                    <div className={"flex-column-start gap-y-2"}>
                      ...
                      <Button
                        className="flex-center w-full gap-x-2 rounded-md border-2 border-primary-500 bg-gray-100 px-4 py-2 text-sm font-medium text-primary-500  shadow-sm"
                      >
                        <Image
