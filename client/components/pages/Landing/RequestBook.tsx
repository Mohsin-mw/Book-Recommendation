...
const formSchema = z.object({
    ...
    isbn: z.string().min(4, {
        message: "ISBN must be at least 4 letters"
    })
})
                                    ...
                                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                                        <FormField
                                            ...
                                            render={({field}) => (
                                                <>
                                                    <FormItem>
                                                        <FormLabel className={"text-gray-900"}>Book Title</FormLabel>
                                                        <FormControl>
                                                            <Input
                                                                className={"no-focus text-primary font-bold ring-primary outline-primary"}
                                                                placeholder="Educated..." {...field} />
                                                        </FormControl>
                                                        <FormDescription>
                                                            Title of the Book (author optional)
                                                        </FormDescription>
                                                        <FormMessage/>
                                                    </FormItem>
                                                </>
                                        ...
                                        <FormField
                                            ...
                                            render={({field}) => (
                                                <>
                                                    <FormItem>
                                                        <FormLabel className={"text-gray-900"}>ISBN</FormLabel>
                                                        <FormControl>
                                                            <Input
                                                                className={"no-focus text-primary font-bold ring-primary outline-primary"}
                                                                placeholder="00293..." {...field} />
                                                        </FormControl>
                                                        <FormDescription>
