...
import {adminGetAllBooks} from "@/network/endpoints/BooksApi";
...
const Page = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            try {
                const response = await adminGetAllBooks(currentPage);
        ...
        <>
            <div className="bg-primary">
                <div className="container text-white font-medium py-4">
                    ...
                    We have {booksSet?.pagination.total_books} books<IconBook/>
                    </span>
                </div>
            </div>
            ...
            <div className="bg-secondary">
                {
                    booksSet?.books ? (
                        <BooksGrid url="admin" gridSize={4} books={booksSet?.books}/>
                    ) : ""
                }
            </div>
            <span className="block h-[3px] bg-slate-200"></span>
